\chapter{Schema SQL completo}
\label{app:database}

Di seguito il contenuto completo del file \texttt{init.sql}, applicato automaticamente
da PostgreSQL al primo avvio.

\begin{lstlisting}[language=SQL, caption={Schema completo del database (\texttt{init.sql}).}]
...
CREATE TABLE agent_files (
    ...
    CONSTRAINT chk_agent_file_source CHECK (source IN ('email','manual_upload')),
